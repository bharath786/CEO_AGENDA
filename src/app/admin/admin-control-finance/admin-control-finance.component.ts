...
@Component({
  selector: 'app-admin-control-finance',
  templateUrl: './admin-control-finance.component.html',
  styleUrls: ['./admin-control-finance.component.css']
})
export class AdminControlFinanceComponent implements OnInit {
    start_date: any;
