...
@Component({
  selector: 'app-admin-control-statutory',
  templateUrl: './admin-control-statutory.component.html',
  styleUrls: ['./admin-control-statutory.component.css']
})
export class AdminControlStatutoryComponent implements OnInit {
    start_date: any;
